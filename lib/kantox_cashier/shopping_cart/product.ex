defmodule KantoxCashier.Product do
  ...
  def price(:CF1), do: Application.get_env(:kantox_cashier, :basket)[:CF1]
  def price(:GR1), do: Application.get_env(:kantox_cashier, :basket)[:GR1]
  def price(:SR1), do: Application.get_env(:kantox_cashier, :basket)[:SR1]
