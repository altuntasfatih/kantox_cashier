...
config :kantox_cashier, :campaigns, [
  {KantoxCashier.Campaign.BulkPurchaseCoffee,
   enabled: true, count_of_coffee: 3, campaigns_amount: 3.75, name: "Bulk Purchase Coffee"},
  {KantoxCashier.Campaign.BulkPurchaseStrawberry,
   enabled: true, count_of_strawberry: 3, campaigns_amount: 0.50, name: "Bulk Purchase Strawberry"},
